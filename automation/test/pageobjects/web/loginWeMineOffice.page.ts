...
class LoginPage {
    // === Private Locators ===
    private get inputUsername() { return $('[data-id="input-username"]'); }
    private get btnNext() { return $('[data-id="btn-next"]'); }
    private get inputMsPassword() { return $('#passwordEntry'); }
    private get btnMsNext() { return $('[data-testid="primaryButton"]'); }
    private get usernameErrorMessage() { return $('[data-id="username-error"]'); }
